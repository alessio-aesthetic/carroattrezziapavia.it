...
const display = Cormorant_Garamond({ subsets: ['latin'], display: 'swap', variable: '--font-display', weight: ['400','500','600'], style: ['normal','italic'] })
const body = Inter({ subsets: ['latin'], display: 'swap', variable: '--font-body' })
export const viewport: Viewport = { themeColor: '#42212d' }
